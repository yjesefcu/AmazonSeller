    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('QuantityReceived', models.IntegerField(default=0, null=True, blank=True)),
                ('QuantityInCase', models.IntegerField(default=0, null=True, blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amount', models.FloatField(null=True, verbose_name='\u5b9e\u6536', blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('RefundCommission', models.FloatField(null=True, blank=True)),
                ('PromotionPrincipal', models.FloatField(null=True, blank=True)),
                ('PromotionShipping', models.FloatField(null=True, blank=True)),
                ('ShippingChargeback', models.FloatField(null=True, blank=True)),
                ('RestockingFee', models.FloatField(null=True, blank=True)),
                ('FBAReturnFee', models.FloatField(null=True, verbose_name='\u9000\u8d27\u8d39', blank=True)),
                ('quantity', models.IntegerField(null=True, blank=True)),
                ('cost', models.FloatField(null=True, verbose_name='\u5355\u4f4d\u6210\u672c', blank=True)),
                ('UnitPrice', models.FloatField(null=True, verbose_name='\u9500\u552e\u5355\u4ef7', blank=True)),
                ('total_cost', models.FloatField(null=True, verbose_name='\u603b\u6210\u672c', blank=True)),
                ('income', models.FloatField(null=True, verbose_name='\u8ba2\u5355\u4ed8\u6b3e', blank=True)),
                ('amazon_cost', models.FloatField(null=True, verbose_name='\u4e9a\u9a6c\u900a\u6240\u6536\u8d39\u7528', blank=True)),
                ('promotion', models.FloatField(null=True, verbose_name='\u4fc3\u9500\u8fd4\u70b9', blank=True)),
                ('amount', models.FloatField(null=True, verbose_name='\u5b9e\u6536', blank=True)),
                ('profit', models.FloatField(default=0, null=True, blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subscribe_fee', models.FloatField(null=True, verbose_name='\u8ba2\u9605\u8d39', blank=True)),
                ('subscription_fee_adjust', models.FloatField(null=True, verbose_name='\u8865\u507f\u91d1\u989d', blank=True)),
                ...
                ('advertising_report_valid', models.BooleanField(default=False)),
            ],
            options={
                'ordering': ['-EndDate'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ShippingChargeback', models.FloatField(null=True, verbose_name='\u4e70\u5bb6\u8fd0\u8d39\u4ed8\u6b3e', blank=True)),
                ('Shipping', models.FloatField(null=True, verbose_name='\u5176\u4ed6-\u8fd0\u8d39', blank=True)),
                ('PromotionShipping', models.FloatField(null=True, verbose_name='\u4fc3\u9500\u8fd4\u70b9-\u8fd0\u8d39', blank=True)),
                ('FBAPerUnitFulfillmentFee', models.FloatField(null=True, verbose_name='\u4e9a\u9a6c\u900a\u7269\u6d41\u57fa\u7840\u670d\u52a1\u8d39', blank=True)),
                ...
                ('Commission', models.FloatField(null=True, verbose_name='\u4f63\u91d1', blank=True)),
                ('PromotionPrincipal', models.FloatField(null=True, verbose_name='\u9500\u552e\u4fc3\u9500\u8fd4\u70b9', blank=True)),
                ('subscription_fee', models.FloatField(null=True, verbose_name='\u8ba2\u9605\u8d39', blank=True)),
